...
pro load_pal, culz, idl_table=itbl, bright=brt, proportion=prp, doppler=doppler
...
; Now load our fancy color table:
  tvlct, r,g,b

; Finally, replace the image palette with a blue-red gradient if requested:
