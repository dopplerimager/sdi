...
case err_code of
	...
	20033: error = 'DRV_TEMPERATURE_CODES'
	20034: error = 'DRV_TEMPERATURE_OFF'
	20035: error = 'DRV_TEMPERATURE_NOT_STABILIZED'
	20036: error = 'DRV_TEMPERATURE_STABILIZED'
	20037: error = 'DRV_TEMPERATURE_NOT_REACHED'
	20038: error = 'DRV_TEMPERATURE_OUT_RANGE'
	20039: error = 'DRV_TEMPERATURE_NOT_SUPPORTED'
	20040: error = 'DRV_TEMPERATURE_DRIFT'
	...
	else: error = string(err_code, f='(i0)') + ' - UNKNOWN ERROR'
